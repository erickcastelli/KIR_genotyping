...
***YOUR SHOULD PERFORM THE NEXT STEPS FOR EACH GENE SEPARATELY.***
***YOUR SHOULD PERFORM THE NEXT STEPS FOR EACH GENE SEPARATELY.***
...
- To use this VCF for association studies, you should consider the copy numbers estimated earlier.
```
